function[ solution ] = simulatedAnnealing_old(hamParams, spinConfig, initialTemp,...
...
%         end 
        ...
        beta = 1/(kB * temp);
        deltaH = energyChange_old(newSpinConfig, indices_to_flip, 1, 1, 1, h, Jzz, Jzzz);
        if deltaH <= 0
            prob = 1;
        else
...
energy = Conf_energy_old(spinConfig, hamParams);
