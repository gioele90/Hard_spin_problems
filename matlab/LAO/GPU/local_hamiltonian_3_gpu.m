function [J_local] = local_hamiltonian_3_gpu( solution, loop )
    ...
    J_local = zeros(num_spins, num_spins, num_spins,'double','gpuArray');
    ...
    random_coupling = coupling_indicies(gpuArray.randi(length(coupling_indicies)));
